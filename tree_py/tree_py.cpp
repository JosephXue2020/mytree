...
void bind_tree(py::module &m, const std::string py_class_name) {
    ...
    py::class_<Class, Node<T>>(m, py_class_name.c_str())
        ...
        .def("search", &Class::search, py::return_value_policy::reference)
        .def("insert", py::overload_cast<Tree<T>*>(&Class::insert), py::return_value_policy::reference)
        .def("insert", py::overload_cast<Tree<T>*, std::string>(&Class::insert), py::return_value_policy::reference)
        .def("attach", py::overload_cast<Tree<T>*>(&Class::attach), py::return_value_policy::reference)
        .def("attach", py::overload_cast<Tree<T>*, std::string>(&Class::attach), py::return_value_policy::reference)
